...
public class EVA2_17_ORDENAR_OBJETOS {
    ...
    public static void main(String[] args) {
        ...
        lListaPer.add(new Persona("Jofiel", "BAZ", 21, 48, true));
        lListaPer.add(new Persona("Angelica", "MORENO", 20, 94, false));
        lListaPer.add(new Persona("Melquiades", "BA", 5, 2, true));
        lListaPer.add(new Persona("Solovino", "BATI", 3, 0, true));
        lListaPer.add(new Persona("Nathan", "BATISTA", 45, 49, true));
